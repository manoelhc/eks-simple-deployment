...
This is a simple IaC prototype to deploy Wordpress to AWS EKS using Terraform. I started this project from scratch using the technologies I've been using ultimately. Why from scratch? It's simple: technology changes all the time. From AWS Services to Terraform modules. This is the opportunity I have to explore new features and share my thoughts with you. So far, I'm focused on delivering the minimum usable IaC. It might change drastically during the course of the roadmap. Feel free to contribute, tell me your thoughts and open an issue.
...
#### High-availability
The main goal of this project it to deliver a basic high-available Wordpress deployment. It starts with 3 application pods distributed in 3 different availability zones. There are 2 auto-scaling mechanisms:
